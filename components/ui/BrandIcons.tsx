...
export const GoogleIcon = (props: React.ComponentProps<"svg">) => (
  <svg xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" viewBox="0 0 268.152 273.883" {...props}>
    <defs>
...
export const AppleIcon = (props: React.ComponentProps<"svg">) => (
  <svg xmlSpace="preserve" viewBox="0 0 814 1000" {...props}>
    <path fill="currentColor" d="M788.1 340.9c-5.8 4.5-108.2 62.2-108.2 190.5 0 148.4 130.3 200.9 134.2 202.2-.6 3.2-20.7 71.9-68.7 141.9-42.8 61.6-87.5 123.1-155.5 123.1s-85.5-39.5-164-39.5c-76.5 0-103.7 40.8-165.9 40.8s-105.6-57-155.5-127C46.7 790.7 0 663 0 541.8c0-194.4 126.4-297.5 250.8-297.5 66.1 0 121.2 43.4 162.7 43.4 39.5 0 101.1-46 176.3-46 28.5 0 130.9 2.6 198.3 99.2zm-234-181.5c31.1-36.9 53.1-88.1 53.1-139.3 0-7.1-.6-14.3-1.9-20.1-50.6 1.9-110.8 33.7-147.1 75.8-28.5 32.4-55.1 83.6-55.1 135.5 0 7.8 1.3 15.6 1.9 18.1 3.2.6 8.4 1.3 13.6 1.3 45.4 0 102.5-30.4 135.5-71.3z"/>
  </svg>
);

export const BkashIcon = (props: React.ComponentProps<"svg">) => (
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 100 100" {...props}>
    <rect width="100" height="100" fill="#E2136E" rx="15"/>
    <g fill="#FFFFFF">
      <path d="M50,18 C32,18 18,32 18,50 C18,68 32,82 50,82 C68,82 82,68 82,50 C82,32 68,18 50,18 Z M50,74 C36.2,74 25,62.8 25,49 C25,35.2 36.2,24 50,24 C63.8,24 75,35.2 75,49 C75,62.8 63.8,74 50,74 Z" />
      <circle cx="50" cy="49" r="16" />
    </g>
  </svg>
);

export const NagadIcon = (props: React.ComponentProps<"svg">) => (
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 500 137.5" {...props}>
    <defs>
    ...
    <g transform="translate(0, 0)">
      <circle cx="68.75" cy="68.75" r="50" fill="url(#nagadGrad)" />
      <path d="M63 48 C63 43 71 43 71 48 V89 C71 94 63 94 63 89 Z" fill="#FFFFFF" />
      <path d="M78 48 C78 43 86 43 86 48 V89 C86 94 78 94 78 89 Z" fill="#FFFFFF" />
      <path d="M48 63 C43 63 43 71 48 71 H89 C94 71 94 63 89 63 Z" fill="#FFFFFF" />
      <g fill="#010101">
        <path d="M142.5,92.5c-4.5,0-7.8-1.5-10-4.5s-3.3-7.1-3.3-12.7V42c0-2.2,0.8-3.9,2.3-5.2c1.5-1.3,3.5-2,6-2h5.7V92.5z M135.2,50.7v24.2h1.7c0.8,0,1.5-0.2,2.2-0.7c0.7-0.5,1.1-1.1,1.1-2V53.4c0-0.9-0.4-1.6-1.1-2.1c-0.7-0.5-1.4-0.7-2.2-0.7H135.2z"/>
        <path d="M174.5,82c2.2,0,4-0.5,5.5-1.5s2.7-2.5,3.6-4.5v6.5h7.2v-47c0-2.2-0.8-4-2.3-5.3s-3.6-2-6.1-2h-3.3c-2.5,0-4.5,0.7-6,2s-2.3,3.1-2.3,5.3v13.9c-2.9-3.2-6.5-4.8-10.9-4.8c-2.3,0-4.5,0.5-6.5,1.4s-3.7,2.2-5.1,3.8s-2.5,3.6-3.1,5.8s-0.9,4.6-0.9,7.2c0,3,0.6,5.7,1.8,8.2s2.9,4.4,5.1,5.8s4.8,2.2,7.7,2.2c2.8,0,5.3-0.6,7.4-1.9s3.8-3,5.1-5.3V82z M162.7,82c-1.6,0-3-0.4-4.2-1.2s-2.1-1.9-2.7-3.4c-0.6-1.5-0.9-3.2-0.9-5.3c0-2,0.3-3.8,0.9-5.4s1.6-2.9,2.7-3.7s2.5-1.3,4.2-1.3c2,0,3.6,0.6,4.9,1.7c1.3,1.1,2.3,2.6,2.9,4.6c0.6,2,0.9,4.2,0.9,6.7s-0.3,4.7-0.9,6.6c-0.6,1.9-1.6,3.3-2.9,4.3S164.7,82,162.7,82z"/>
        <path d="M211.5,92.5c2.3,0,4.4-0.5,6.1-1.5c1.7-1,3.2-2.5,4.3-4.4v5.9h7.2v-47c0-2.2-0.8-3.9-2.3-5.2c-1.5-1.3-3.6-2-6.1-2h-3.3c-2.5,0-4.5,0.7-6.1,2c-1.5,1.3-2.3,3.1-2.3,5.2V78c-1.1-1.9-2.7-3.3-4.6-4.3c-2-1-4.1-1.5-6.5-1.5c-3.1,0-5.7,0.9-7.8,2.7s-3.8,4.2-5,7.2s-1.8,6.5-1.8,10.4c0,3.9,0.6,7.3,1.8,10.2s3,5.2,5.1,6.9c2.1,1.7,4.6,2.5,7.6,2.5c2.5,0,4.6-0.5,6.5-1.5s3.5-2.5,4.7-4.4V92.5z M212.4,82c-1.7,0-3.2-0.4-4.5-1.2c-1.3-0.8-2.3-2-3-3.6c-0.7-1.6-1.1-3.4-1.1-5.6c0-2.1,0.4-3.9,1.1-5.5s1.7-2.9,3-3.7s2.8-1.2,4.5-1.2c1.7,0,3.2,0.4,4.5,1.3c1.3,0.9,2.3,2.1,3,3.8c0.7,1.7,1.1,3.5,1.1,5.6c0,2.2-0.4,4-1.1,5.5s-1.7,2.8-3,3.7S214.1,82,212.4,82z"/>
      </g>
    </g>
  </svg>
);
